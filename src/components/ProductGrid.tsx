...
const ProductSkeletonCard: React.FC = () => (
  <div className="bg-white rounded-lg border border-slate-200 overflow-hidden animate-pulse flex flex-col">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 pt-6">
        ...
        <div className="lg:col-span-3">
          {isProductsLoading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5" aria-busy="true" aria-label="Loading products">
